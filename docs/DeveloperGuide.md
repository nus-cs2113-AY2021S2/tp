...
1. [Doctor Appointment](#53-doctor-appointment)
    - [Doctor Appointment Menu](#531-doctor-appointment-menu)
    - [Doctor Appointment Add](#532-doctor-appointment-add)
    - [Doctor Appointment Delete](#533-doctor-appointment-delete)
    - [Doctor Appointment List All](#534-doctor-appointment-list-all)
    - [Doctor Appointment List by Doctor ID or Appointment ID](#535-doctor-appointment-list-by-doctor-id-or-appointment-id)
    
1. [Nurse Schedule](#54-nurse-schedule)
    - [Nurse Schedule Menu](#541-nurse-schedule-menu)
    - [Nurse Schedule Add](#542-nurse-schedule-add)
    - [Nurse Schedule Delete](#543-nurse-schedule-delete)
    - [Nurse Schedule List All](#544-nurse-schedule-list-all)
    - [Nurse Schedule List by Nurse ID](#545-nurse-schedule-list-by-nurse-id)
    
1. [Inventory](#55-inventory)
    - [Inventory Menu](#551-inventory-menu)
    - [Inventory Add](#552-inventory-add)
    - [Inventory Delete](#553-inventory-delete)
    - [Inventory List](#554-inventory-list)
    
1. [Proposed Features](#56-proposed-features)
