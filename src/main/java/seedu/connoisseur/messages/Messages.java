...
public class Messages {
    ...
    public static final String INVALIDPRICE_LOW = "Please input a price higher than 0.00";
    public static final String INVALIDPRICE_HIGH = "Please input a price lower than 9999";
