...
public class Messages {
    ...
    public static final String MESSAGE_CHECK_HEADER = "Index    Date Set          Goal Type       "
            + "Target          Progress\n";
    public static final String MESSAGE_VIEW_HEADER_EXERCISE = "Index        Date          "
            + HEADER_FOR_EXERCISE_RECORD_ACTIVITY + HEADER_FOR_EXERCISE_RECORD_DURATION + "Calories\n";
    ...
    public static final String MESSAGE_INVALID_WORKOUT_MIN = "The duration you entered is invalid.\n"
            + "It should be an positive floating point within range 0 and 1440 (not including 0), "
            + "with the unit of minute.\nPlease try again.";
