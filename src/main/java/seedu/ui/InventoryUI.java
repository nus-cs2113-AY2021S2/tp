...
public class InventoryUI extends UI{
    ...
    public static void drugAddedMessage(String name) {
        System.out.println(name + " is added into Inventory Inventory!");
    }
    ...
    /*public static void drugNotFoundMessage() {
        System.out.println("OOPS! Inventory not found in the inventory");
    }
*/
    ...
    public static void DrugCommandWelcome() {
        System.out.println("Welcome to the Inventory Inventory!");
        printDrugHelpList();
    }
