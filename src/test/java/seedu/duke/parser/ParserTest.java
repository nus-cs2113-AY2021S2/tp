...
class ParserTest {
    ...
    // IN MODULE COMMAND
    // add lesson command
    void parse_inModuleCommandListTask_ListTask() throws CommandException, ParserException {
        ModuleList.reset();
    ...
    void checkIndices_variousInputs_processedArrayList() {
        ...
        String input5 = "10 1 -1 -99 -2 10918 2 3 abc"; // out of bounds and duplicates and negative
