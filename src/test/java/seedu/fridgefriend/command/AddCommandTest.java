...
class AddCommandTest {
    ...
    @Test
    public void addCommand_foodCorrectFormat_successfullyAdded() throws InvalidDateException {
    ...
    @Test
    public void addCommand_foodCorrectFormat_changeFoodParameters() throws InvalidDateException {
        AddCommand addCommand = new AddCommand("chicken", FoodCategory.MEAT,
                "30-06-2021", FoodStorageLocation.FREEZER);
        addCommand.setData(fridge);
        addCommand.execute();
